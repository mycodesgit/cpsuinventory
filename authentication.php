<?php	
	...
	*/
	...
	$restricted_pages[ 'Administrator' ]['access'] = [ "dashboard", "profile", "inventory", "add-inventory", "edit-inventory", "category", "logstatus", "classification", "edit-classification", "offices", "edit-office", "users", "edit-user" ];
